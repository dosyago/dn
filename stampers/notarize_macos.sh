...
usage() {
    ...
    echo "Example: $0 --binary ./bin/dn-macos --keychain-profile cris-notarization-profile --bundle-id com.DOSAYGO.DownloadNet --version 4.5.1 --installer-cert 'Developer ID Installer: THE DOSYAGO CORPORATION (9H7RQ78X7U)'"
    exit 1
}
